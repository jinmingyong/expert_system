...
import com.jin.expertsystem.expertsystem.utils.SerializeUtil;
...
public class RedisUtil {
    ...
    public String setObj(String key,Object object,Integer dbNum)
    {
        Jedis jedis = null;
        try {
            jedis = jedisPool.getResource();
     ...
     * @return
     */
    public Long expireAt(String key, Long value, int indexdb) {
        Jedis jedis = null;
        try {
            jedis = jedisPool.getResource();
            jedis.select(indexdb);
            return jedis.expireAt(key,value);
        } catch (Exception e) {
            log.error(e.getMessage());
            return 0L;
        } finally {
