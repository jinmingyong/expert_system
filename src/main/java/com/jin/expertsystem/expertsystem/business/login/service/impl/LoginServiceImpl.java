...
import com.jin.expertsystem.expertsystem.business.common.dao.*;
...
import com.jin.expertsystem.expertsystem.business.login.dao.MenuInfoDao;
...
//            Students students = loginDao.queryStudentStatus(userNumber);
//            if (students != null){
//                if (students.getStudentStatus() == 1) {
